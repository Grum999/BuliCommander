...
# -----------------------------------------------------------------------------
# The bcconvertifle module provides classe to made conversion of a file to
# another file format
#
# Main class from this module
#
# - BCConvertFilesDialogBox:
#       A user interface with basics options for file conversion
#
# -----------------------------------------------------------------------------
