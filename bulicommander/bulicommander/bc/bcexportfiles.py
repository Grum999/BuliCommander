...
# -----------------------------------------------------------------------------
# The bcexportfiles module provides classes used to manage export of a list of
# images in different format
#
# Main classes from this module
#
# - BCExportFilesDialogBox:
#       A user interface with options to define file export
#
# - BCExportFiles
#       Provides methods to process export
#
# -----------------------------------------------------------------------------
